...
from tensorflow.keras.layers import BatchNormalization, Activation, Conv1D, Add, MaxPooling1D, Dense, Dropout, TimeDistributed, Lambda
...
def add_conv_weight(layer, filter_length, num_filters, subsample_length=1, **params):
    layer = Conv1D(filters=num_filters, kernel_size=filter_length, strides=subsample_length, padding='same',kernel_initializer=params["conv_init"])(layer)
    return layer
